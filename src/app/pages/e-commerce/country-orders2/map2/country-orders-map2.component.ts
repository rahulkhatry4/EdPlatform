...
import { CountryOrdersMap2Service } from './country-orders-map2.service';
...
export class CountryOrdersMap2Component implements OnDestroy {
  ...
  constructor(private ecMapService: CountryOrdersMap2Service,
