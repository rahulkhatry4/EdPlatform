...
@Component({
  selector: 'ngx-country-orders-chart2',
  styleUrls: ['./country-orders-chart2.component.scss'],
  template: `
    <div class="header">
...
export class CountryOrdersChart2Component implements AfterViewInit, OnDestroy, OnChanges {
