...
@Component({
  selector: 'ngx-room2-selector',
  templateUrl: './room2-selector.component.html',
  styleUrls: ['./room2-selector.component.scss'],
})
export class Room2SelectorComponent implements OnInit, OnDestroy {
